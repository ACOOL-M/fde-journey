"""
Week 6 Day 2: AI 销售助手网页版
把 Week 5 的终端工具升级成 Web 应用（Streamlit）
...
运行方式：python -m streamlit run week6-day2.py
"""
...
st.caption("Week 6 Day 2 · Streamlit 全功能整合 · 运行方式: python -m streamlit run week6-day2.py")
...
st.divider()
st.caption(f"💾 本次会话已记录 {len(st.session_state.log)} 次操作 · 点侧边栏「导出操作记录 CSV」下载 · FDE Week 6 Day 2")
